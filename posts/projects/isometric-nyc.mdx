...
And so I started this project as I start almost every project now - [by asking Gemini](/chats/isometric-nyc-initial-gemini).
...
[tasks/004_tiles.md](/tasks/004_tiles)

![isometric web render of city geometry plus from Google Maps 3D tiles](/img/projects/isometric-nyc/web_render.png)

### / Image Generation

After a bit of prompt hacking, I was able to get Nano Banana Pro to generate tiles in my preferred style fairly reliably. 

![generated pixel art image from Nano Banana Pro](/img/projects/isometric-nyc/nano_banana_output.png)
...
[tasks/014_bounds_app.md](/tasks/014_bounds_app)  
...
[tasks/018_water_fix.md](/tasks/018_water_fix)  
