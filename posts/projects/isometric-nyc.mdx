...
![whitebox render of city geometry plus satellite texture](/img/projects/isometric-nyc/whitebox.png)
...
[tasks/004_tiles.md](/tasks/004_tiles.md)

![web render of city geometry plus from Google Maps 3D tiles](/img/projects/isometric-nyc/web_render.png)
...
![input/output pairs for fine-tuning Qwen/Image-Edit](/img/projects/isometric-nyc/training_pairs_gen.png)

[tasks/005_oxen_api.md](/tasks/005_oxen_api)
...
![infill pair images / diagram](/img/projects/isometric-nyc/training_data_infill.png)

[tasks/006_infill_dataset.md](/tasks/006_infill_dataset)  
[tasks/009_inpainting.md](/tasks/009_inpainting)  
[tasks/010_omni_generation_dataset.md](/tasks/010_omni_generation_dataset)
...
<Video src="/img/projects/isometric-nyc/gen_app_screencast.webm" />

[tasks/007_e2e_generation.md](/tasks/007_e2e_generation)  
[tasks/008_e2e_generation_pixels.md](/tasks/008_e2e_generation_pixels)  
[tasks/012_generation_rules.md](/tasks/012_generation_rules)  
[tasks/013_generation_app.md](/tasks/013_generation_app)  
...
[tasks/014_bounds_app.md](/tasks/014_bounds_app.md)  

![debug map showing the tiles that have been generated](/img/projects/isometric-nyc/debug_map.png)
...
![water and trees caused lots of issues for the models](/img/projects/isometric-nyc/water_tree_issues.png)
...
[tasks/018_water_fix.md](/tasks/018_water_fix.md)  
...
![a sample of tile generation rules to avoid seams](/img/projects/isometric-nyc/gen_rules.png)
...
[015_automatic_generation.md](/tasks/015_automatic_generation)  
[016_generation_playbook.md](/tasks/016_generation_playbook)  
[019_strip_plan.md](/tasks/019_strip_plan)  
...
<iframe src="https://cannoneyed.github.io/isometric-nyc/" width="100%" height="600" />
